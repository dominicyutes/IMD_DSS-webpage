        ...
        <section class="content">
                                ...
                                <div class="col-md-12" id="initial_max">
                                    <div class="box">
                                        <div class="box-header with-border">
                                            <h5 class="box-title"><i class="fa fa-calendar-check-o"></i> Day [<span style="color: #00b3ee;" ><?php echo date('d-M-Y', strtotime("$curr_date")); ?></span>]</h3>
                                        </div>
                                        <div class="box-body">
                                            ...
                                            <div class="nav-tabs-custom">
                                                <ul class="nav nav-tabs">
                                                    <li class="pull-right"><img  title="open" id="toggle_right_panel" attr-togglev="1" class="toggle_right_panel" src="<?php echo base_url('stylesheet/images/collapse_open.png'); ?>" style="display: none; float: right; height: 20px; width:20px;" /> </li>
                                                </ul>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title">District Wise Alert</h3>
                        </div><!-- /.box-header -->
                        <div class="box-body">
...
<script type="text/javascript">
    ...
    info.update = function (props) {
        if( active_map_type === 'block_from_district' && !(selected_district_id)){
            ...
            this._div.innerHTML = '<h4>Information</h4>' +  (props ?
            '<b> State : ' + props.state + '<br /> District : ' + props.district +'</b>'
            : 'Hover Over a District');    
        }
    };
    info.addTo(mymap);
...
// for both select function
    ...
    $("#back_bt").click(function() {
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('ValueAddition/MaxTemp/Block_from_district'); ?>",
    ...
    function AJaxSaveAlert(data_list){
        ...
        return data = $.parseJSON($.ajax({
                        type: "POST",
                            url: "<?php echo site_url('ValueAddition/MaxTemp/saveAlertData'); ?>",
                            data: {
    ...
    function AJAXLatestUpdate(fcst_date, fcst_type){
        $.ajax({
                type: "POST",
                url: "<?php echo site_url('ValueAddition/MaxTemp/get_updated_info'); ?>",
                data: {
                    fcst_date: fcst_date,
    ...
    var india_state = new L.GeoJSON.AJAX("<?php echo base_url(); ?>DATA/INDIA_STATE.json",
            {
                color: 'brown',
                dashArray: '5, 5', 
                dashOffset: '0',
    ...
    var ctl_india_state = L.layerGroup([india_state]);
    ...
    $("#regionals").on("change",function(e){
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('ValueAddition/MaxTemp/block_from_region'); ?>",
