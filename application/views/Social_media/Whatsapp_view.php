                ...
                <div class="col-3 font">
                    ...
                    <div class="btn-group dropend">
                        ...
                        <ul class="dropdown-menu" style="height: 20rem; overflow-y: scroll;">
                            ...
                            <li><a class="dropdown-item" href="#" onclick="setInputValue('MC_Lucknow')">MC_Lucknow</a>
                            </li>
                            ...
                            <li><a class="dropdown-item" href="#" onclick="setInputValue('MC_Shillong')">MC_Shillong</a>
                            </li>
                            <li><a class="dropdown-item" href="#" onclick="setInputValue('MC_Shimla')">MC_Shimla</a>
                            </li>
                            <li><a class="dropdown-item" href="#" onclick="setInputValue('MC_Srinagar')">MC_Srinagar</a>
                            </li>
                            <li><a class="dropdown-item" href="#"
