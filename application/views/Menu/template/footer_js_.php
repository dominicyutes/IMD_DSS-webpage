...
<!-- jQuery -->
<script src="<?php echo base_url('stylesheet')?>/plugins/jquery/jquery.min.js"></script>
<!-- jQuery UI 1.11.4 -->
<script src="<?php echo base_url('stylesheet')?>/plugins/jquery-ui/jquery-ui.min.js"></script>
...
<!-- overlayScrollbars -->
<script src="<?php echo base_url('stylesheet')?>/plugins/overlayScrollbars/js/jquery.overlayScrollbars.min.js"></script>
<!-- AdminLTE App -->
<script src="<?php echo base_url('stylesheet')?>/dist/js/adminlte.js"></script>
<!-- AdminLTE dashboard demo (This is only for demo purposes) -->
<!-- <script src="<?php echo base_url('stylesheet')?>/dist/js/pages/dashboard.js"></script>
<script src="<?php echo base_url('stylesheet')?>/dist/js/demo.js"></script> -->