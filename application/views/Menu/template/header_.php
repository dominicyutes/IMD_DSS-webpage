...
<head>
    ...
    <link rel="stylesheet"
        href="<?php echo base_url('stylesheet')?>/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css">
    <!-- iCheck -->
    ...
    <!-- overlayScrollbars -->
    <link rel="stylesheet"
        href="<?php echo base_url('stylesheet')?>/plugins/overlayScrollbars/css/OverlayScrollbars.min.css">
    <!-- Daterange picker -->
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div style="height: 100%;">
        <div class="fixedHead">
            <img src="<?php echo base_url('img/emblem.png'); ?>" alt="Emblem of India" height="30"
                style="padding-left: 1%;">
            <div style="flex: 1; text-align: center;">
                <span class="text" style="font-family: 'Times New Roman';">WEATHER DECISION SUPPORT SYSTEM</span>
            </div>
            <img src="<?php echo base_url('img/imd_logo_a.png'); ?>" alt="IMD logo" height="35"
