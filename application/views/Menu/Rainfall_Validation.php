...
<div class="parent">
    <div class="content-wrapper">
        <section class="content">
            ...
            <h4 style="font-family: 'Times New Roman', Times, serif; display: inline;">RAINFALL VALIDATION</h4>

            <div class="box box-info" style="height: 771px;
">
                <div style="padding-top: 5px; padding-bottom: 5px;">
                    Click on the <img src="img/anime/stations.gif" alt="Station Icon" style="width: 25px;">station to
                    view the comparison plot. You can even use the <img src="img/anime/calendar.gif" alt="calendar"
                        style="width: 20px;">date and
                    parameter
                    filters.
                </div>
                ...
                <div id="reportrange"
                    ...
                    <img src="img/anime/calendar.gif" alt="calendar" style="width: 25px;">&nbsp;
                ...
                <div class="box-body">
                    <div class="active tab-pane" id="showmap">
                        <div class="post">
                            ...
                            <div class="box-body">
                                <div id="container"
                                    style="border:#333 1px ridge; overflow: hidden; width: 100%;     margin-top: -35px;">
                                    <div id="map_canvas" style="width: 100%; height: 688px; float: left; z-index: 0;"
                                        align="center"></div>
                                </div>
                            </div>
                            <div id="toggleDiv" style="display: none; flex-direction: column; padding: 20px; border: 2px solid #000; border-radius: 10px; margin-top: -698px; width: 265px; margin-left: 870px; height: 684px;">
                                ...
                                <div style="display: flex; flex-direction: column; justify-content: space-between;">
                                    ...
                                    <div
                                        style="width: 100%; padding: 20px; border: 1px solid #ccc; border-radius: 10px; height: 388px;">
                                        <div
