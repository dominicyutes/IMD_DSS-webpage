...
<script>
// Set default values for img tag and documentTitle
var defaultImgSrc = "https://mausam.imd.gov.in/responsive/img/logo/imd_logo_a.png";
var defaultDocumentTitle = "WEATHER DECISION SUPPORT SYSTEM";

// Add the default values to the header
// L.control.browserPrint({
//     position: 'topleft',
//     documentTitle: defaultDocumentTitle,
//     documentTitleClass: 'print-title',
//     headerTitle: '<img src="' + defaultImgSrc + '" alt="IMD" width="500" height="600">'
// }).addTo(map);
// 
</script>
