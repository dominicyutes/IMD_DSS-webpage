...
<body>
    ...
    <div style="display: flex; align-items: center;">
        <img src="img/emblem.png" alt="IMD logo" height="35" >
        <span class="text" style="font-family: 'Times New Roman'; color: white; font-size: 25px;">WEATHER DECISION SUPPORT SYSTEM</span>
        <img src="img/imd_logo.png" alt="Emblem of India" height="35">
    </div>
</div>
<?php
