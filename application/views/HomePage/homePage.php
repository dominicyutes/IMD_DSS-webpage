...
<body>
    ...
    <div class="model" style="display: none; left: 253px; top: 94px; height:0;">
        ...
        <h1 class="title" leaflet-browser-print-content>WEATHER DECISION SUPPORT SYSTEM</h1>
        <h3 class="sub-content" leaflet-browser-print-content>Leaflet browser print plugin for map printing with
            additional
            controls and content</h3>
        <div id="mapp">ngfvncnv</div>
        <table leaflet-browser-print-pages>
            ...
            <tbody>
                ...
                <tr>
                    <td>position</td>
                    <td><a href="http://leafletjs.com/reference-0.7.7.html#control-position" rel="nofollow">Leaflet
                            control position</a>
                    </td>
                    <td>'topleft'</td>
                ...
                <tr>
                    <td>printLayer</td>
                    <td><a href="http://leafletjs.com/reference-0.7.7.html#tilelayer" rel="nofollow">Leaflet tile
                            layer</a></td>
                    <td>null</td>
                ...
                <tr>
                    ...
                    <td>Content selector for printed map, will select and dynamically inject content on printed maps.
                        For full
        ...
        <script src="https://cdn.jsdelivr.net/npm/@geoman-io/leaflet-geoman-free@latest/dist/leaflet-geoman.min.js">
        </script>
        <script>
        ...
        // var p = L.polygon(arrayOfPoints, {
        //     color: 'yellow'
        // }).bindTooltip("polygon").bindPopup('This is Polygon, CO.').addTo(cities);
        ...
        // L.popup({
        //     minWidth: 500
        // }).setLatLng(L.latLng(39.73, -104.99)).setContent(
        //     "Leaflet browser print plugin with custom print Layer and content").openOn(map);
