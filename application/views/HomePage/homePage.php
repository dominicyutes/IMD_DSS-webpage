            ...
            if (ajaxUrl !== "") {
                $.ajax({
                    ...
                    success: function (names) {
                        // Assuming populateDropdown is defined elsewhere
                        populateDropdown(names);
                    },
                    error: function () {
                        console.error('Error fetching names via AJAX.');
                    }
                });
            } else {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        try {
                            ...
                            // Check if latitudes and longitudes are available in the response
                            if (data.hasOwnProperty('latitudes') && data.hasOwnProperty('longitudes')) {
                                ...
                                console.error('Incomplete data in response.');
                            }
                        } catch (error) {
